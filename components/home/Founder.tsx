        ...
        <div className="fd-wrap">
          ...
          <div className="fd-grid sec-body">
            <div>
              ...
              <p className="fd-body">
                デザインの前に、お店の魅力をどう伝えるかを、一緒に考えます。文章がまとまっていなくても大丈夫です。ヒアリングと既存情報の整理から一緒に進めます。
              </p>

              <div className="fd-profile">
                <h3 className="fd-profile-h">プロフィール</h3>
                <p>
                  愛知県名古屋市・金山駅周辺を拠点に活動しています。大学で学びながら、パン屋の現場に立ち、Second Rootとして地域のお店のホームページ制作を行っています。名古屋市内は対面でのご相談も可能です。全国からオンラインでご相談いただけます。
                </p>
              </div>
            </div>
